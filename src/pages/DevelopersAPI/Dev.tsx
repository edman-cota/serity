            ...
            <div className='introduction'>
              <div className='doc-row'>
                <div className='doc-content'>
                  ...
                  <p>The Cota REST API provides a broad set of operations and resources that:</p>
                  <ul>
                    ...
                    <li>
                      ...
                      <ul>
                        <li>
                          Pull information from other locations such as email and Evernote into
                          Cota.
                        </li>
                        <li>
                  ...
                  <p>
                    Want to share your thoughts on how Cota API works for you? Tell us how you feel
