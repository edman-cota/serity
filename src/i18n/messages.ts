...
export const messages = {
  [LOCALES.ENGLISH]: {
    ...
    just_now: "Just now",
    added: "added",
    set_the_priority_of: "set the priority of",
    set_the_due_date_of: "set the due date of",
    unset_the_due_date_of: "unset the due date of",
    completed: "completed",
    reopen: "reopen",
  ...
  [LOCALES.SPANISH]: {
    ...
    added: "añadió",
    set_the_priority_of: "estableció la priodidad de",
    set_the_due_date_of: "estableció la fecha de vencimiento de",
    unset_the_due_date_of: "quitó la fecha de vencimiento de",
    completed: "completó",
    reopen: "reabrió",
